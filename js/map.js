...
colorAxis: {
    ...
    stops: [
        [0, 'rgba(0, 108, 238, 0)'],
        [0.1, 'rgba(0, 108, 238, 0.2)'],
        [0.2, 'rgba(0, 108, 238, 0.4)'],
        [0.3, 'rgba(0, 108, 238, 0.6)'],
        [0.4, 'rgba(0, 108, 238, 0.8)'],
        [0.5, 'rgba(0, 108, 238, 1)'],
        [0.6, 'rgba(0, 180, 238, 1)'],
        [0.7, 'rgba(0, 220, 238, 1)'],
        [0.8, 'rgba(0, 238, 200, 1)'],
