...
colorAxis: {
    ...
    maxColor: 'rgba(255, 192, 203, 1)',
    stops: [
        [0, 'rgba(0, 108, 238, 0)'],
        [0.1, 'rgba(36, 119, 225, 0.1)'],
        [0.2, 'rgba(73, 131, 212, 0.2)'],
        [0.3, 'rgba(109, 142, 198, 0.3)'],
        [0.4, 'rgba(146, 154, 185, 0.4)'],
        [0.5, 'rgba(182, 165, 171, 0.5)'],
        [0.6, 'rgba(219, 177, 158, 0.6)'],
        [0.7, 'rgba(255, 188, 144, 0.7)'],
        [0.8, 'rgba(255, 174, 162, 0.8)'],
        [0.9, 'rgba(255, 183, 182, 0.9)'],
